...
impl State {
    async fn new(window: &Window) -> Self {
        ...
        let temp_verticeles: Vec<Vertex> = vec![
            Vertex {
                position: [-0.0868241, 0.49240386, 0.0],
                color: [0.5, 0.0, 0.5],
            }, // A
        ...
        let vertex_buffer = device.create_buffer_init(&mut wgpu::util::BufferInitDescriptor {
            label: Some("Vertex Buffer"),
            contents: bytemuck::cast_slice(&temp_verticeles),
